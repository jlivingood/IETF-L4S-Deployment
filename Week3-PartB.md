...
1. Download the .ini file with the DNS servers pre-configured (right-click link and choose "Save Link As..."): https://github.com/jlivingood/IETF-L4S-Deployment/blob/main/DNSBench.ini.
